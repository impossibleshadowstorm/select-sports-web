...
//       if (!slotId) {
//         return NextResponse.json({ success: false, message: 'Slot ID is required in the URL.' }, { status: 400 });
//       }
...
//       const currentTime = new Date();
//       const slotTime = new Date(slot.startTime);
//       const timeDiffHours = (slotTime.getTime() - currentTime.getTime()) / (1000 * 60 * 60);
//       if (timeDiffHours < 3) {
//         return NextResponse.json({ success: false, message: 'Booking must be made at least 3 hours before the slot starts.' }, { status: 400 });
//       }
...
//       if (existingBooking) {
//         return NextResponse.json({ success: false, message: 'You have already booked this slot.' }, { status: 400 });
//       }
...
//         {
//           success: false,
//           message: 'Insufficient wallet balance. Please pay the remaining amount.',
//           amountToPay: amountToPay,
//           razorpayOptions: {
